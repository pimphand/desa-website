        ...
        <div class="page-main-header">
            <div class="main-header-right">
                <div class="main-header-left text-center">
                    <div class="logo-wrapper"><a href="index.html"><img
                                src="{{asset('html/assets')}}/images/logo/logo.png" alt=""></a></div>
                </div>
                ...
                <div class="nav-right col pull-right right-menu">
                    <ul class="nav-menus">
                        ...
                        <li class="onhover-dropdown"><img class="img-fluid img-shadow-warning"
                                src="{{asset('html/assets')}}/images/dashboard/bookmark.png" alt="">
                        ...
                        <li class="onhover-dropdown"><img class="img-fluid img-shadow-secondary"
                                src="{{asset('html/assets')}}/images/dashboard/like.png" alt="">
                        ...
                        <li class="onhover-dropdown"><img class="img-fluid img-shadow-warning"
                                src="{{asset('html/assets')}}/images/dashboard/notification.png" alt="">
                        ...
                        <li><a class="right_side_toggle" href="#"><img class="img-fluid img-shadow-success"
                                    src="{{asset('html/assets')}}/images/dashboard/chat.png" alt=""></a></li>
                        <li class="onhover-dropdown"> <span class="media user-header"><img class="img-fluid"
                                    src="{{asset('html/assets')}}/images/dashboard/user.png" alt=""></span>
